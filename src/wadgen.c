...
static void
WGen_AddLumpFile (const char *name) {
    path file;
    int size;
    cache data;
    char lumpname[16];
...
void
WGen_AddDigest (char *name, int lump, int size) {
    char buf[9];
...
void
WGen_ConvertN64Pal (dPalette_t * palette, word * data, int indexes) {
    int i;
    short val;
    cache p = (cache) data;
