...
void
Deflate_CheckTable (int a0, int a1, int a2) {
    int i = 0;
    byte *t7p;
    byte *v0p;
    int idByte1;
...
void
Deflate_WriteOutput (byte outByte) {
...
void
Deflate_Decompress (byte * input, byte * output) {
    int v[2];
    int a[4];
    int s[10];
    int t[10];
