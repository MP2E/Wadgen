...
static const romLumpSpecial_t GfxNames[] = {
    ...
    {"FIRE", "EPJX"}, {"CLOUD", "EPJX"}, {"IDCRED1", "EPJX"}, {"IDCRED2",
                                                               "EPJX"},
    {"WMSCRED1", "EPJX"}, {"WMSCRED2", "EPJX"}, {"FINAL", "EPJX"}, {"JPCPAK",
                                                                    "J",},
...
void
Gfx_CreateRomLump (gfxRom_t * gfx, cache data) {
    int32 size = 0;
...
void
Gfx_CreateRomFireLump (gfxRom_t * gfx, cache data) {
    int32 size = 0;
...
void
Gfx_CreateEXLump (gfxEx_t * pcGfx, gfxRom_t * romGfx) {
    int w = 0;
    int h = 0;
...
void
Gfx_CreateFirePalette (gfxEx_t * pcGfx) {
    int i = 0;
...
void
Gfx_GetCloudLump (gfxEx_t * pcGfx) {
    int l = 0;
    int i = 0;
    int mask = 64 / 4;
    int *tmpSrc;
